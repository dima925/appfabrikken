...
(function ($) {
    ...
    init: function () {
      ...
      img.onload = function (e) {
        ...
        EXIF.getData(img, function () {
          ...
          if(!orientation && iw>ih){ //if can't fetch orientation and image is in landscape
            orientation = 6;
          }
          //alert($(img).exif('Orientation'));
          ...
          //if ($this.options.type === "image/png") {
      ...
      dataURL = correctImageDataURI(dataURL);
  ...
  $[pluginName] = function (file, options) {
    if (typeof file === 'string' && (!options || !options.callback))
