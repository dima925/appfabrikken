angular.module('starter.controllers.psmenus2', []).controller('PersonalmenusCtrl_2', function ($scope, $ionicLoading, $stateParams, Api, Constants, $rootScope, $state, Tools, $firebaseArray, $firebaseObject) {
  $scope.menus = [];
