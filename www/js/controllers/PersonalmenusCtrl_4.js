angular.module('starter.controllers.psmenus4', []).controller('PersonalmenusCtrl_4', function ($scope, $ionicLoading, $stateParams, Api, Constants, $rootScope, $state, Tools, $firebaseArray, $firebaseObject) {
  $scope.menus = [];
